{{-- Bootstrap 4 Single Column Form Structure for Laravel --}}
{{-- Self-contained reusable component with Bootstrap 4 and vanilla JavaScript --}}

<div id="bootstrap-single-column-form" class="bootstrap-form-container">
    <style>
    ...
    <form method="POST" action="{{ route('functions.submit-form') }}" id="singleColumnForm" novalidate>
        @csrf
        ...
        <h4 class="mb-4 text-center">Single Column Form</h4>
    ...
    <script>
        // Single Column Form Validator
        (function() {
            'use strict';

            class SingleColumnFormValidator {
                constructor() {
                    this.form = document.getElementById('singleColumnForm');
