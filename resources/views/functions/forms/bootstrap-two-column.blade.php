{{-- Bootstrap 4 Two Column Form Structure for Laravel --}}
{{-- Self-contained reusable component with Bootstrap 4 and vanilla JavaScript --}}

<div id="bootstrap-two-column-form" class="bootstrap-form-container">
    <style>
    ...
    <form method="POST" action="{{ route('functions.submit-form') }}" id="twoColumnForm" novalidate>
        @csrf
        ...
        <h4 class="mb-4 text-center">Two Column Form</h4>
    ...
    <script>
        // Two Column Form Validator
        (function() {
            'use strict';

            class TwoColumnFormValidator {
                constructor() {
                    this.form = document.getElementById('twoColumnForm');
